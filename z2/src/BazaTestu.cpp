 ...
 */
 ...
 { {{21,12.3}, Op_Dodaj, {1.73,2.21}},
    {{21,12.3}, Op_Odejmij, {1.73,2.21}},
    {{21,12.3}, Op_Mnoz, {1.73,2.21}},
    {{21,12.3}, Op_Dziel, {1.73,2.21}},
  };
